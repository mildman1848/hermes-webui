...
class Session:
    def __init__(self, session_id: str=None, title: str='Untitled',
        ...
        self.owner = str(owner or kwargs.get('owner') or '').strip().lower() or None
    ...
    def save(self, touch_updated_at: bool = True, skip_index: bool = False) -> None:
        ...
        METADATA_FIELDS = [
            ...
            'enabled_toolsets', 'composer_draft', 'owner',
        ]
...
def new_session(workspace=None, model=None, profile=None, model_provider=None, project_id=None, worktree_info=None, enabled_toolsets=None, owner=None):
